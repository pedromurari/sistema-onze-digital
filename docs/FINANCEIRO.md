...
| 2026-09-10 | **Config populado + Asaas backfill.** `balanco_config`: `saldo_inicial_contas` (09/09: inter 2620,94 / c6 2234,40 / mp 38,20 / asaas 508,56 / voomp 413,86), `saldo_caixa_manual` 5815,96. `conta_recebimento='asaas'` + `taxa_valor=1.99` em 7 pagamentos casados 1:1 com o extrato Asaas (nome+valor+data) — de 1 para 8 dos ~110 pagamentos com conta preenchida. Custo do evento Espaço Certo (NPA #19 Santos) R$900 lançado; repasse Keila set R$54,95. |
