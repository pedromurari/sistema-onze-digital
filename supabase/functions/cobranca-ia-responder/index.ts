...
function buildSystemPrompt(): string {
  return [
    ...
    "Se você não tiver certeza do que o aluno quis dizer: primeiro confira no 'Histórico da conversa' se você (papel: agente) já fez alguma pergunta de esclarecimento antes nesta mesma conversa. Se NUNCA perguntou: pergunte UMA vez pra esclarecer (handoff=false). Se você JÁ perguntou uma vez antes e a resposta do aluno continua vaga/confusa: NÃO pergunte de novo — vá direto pra handoff=true, motivo_handoff='baixa_confianca'. Nunca insista mais de uma vez pedindo a mesma coisa.",
