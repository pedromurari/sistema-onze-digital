...
function buildSystemPrompt(conhecimentoAprendido: { pergunta_exemplo: string; resposta: string }[], midiasJaEnviadas: string[], oferta: Oferta | null, dentroDoHorario: boolean): string {
  ...
  const partes = [
    ...
    "Emoji: use no MÁXIMO 1-2 por mensagem, e SEMPRE no final de uma frase ou parágrafo -- nunca no meio cortando o fluxo de leitura (errado: 'Nossa formação 💙 tem 27 módulos e você vai aprender muito 🎯 com professores incríveis'; certo: 'Nossa formação tem 27 módulos e você vai aprender muito com professores incríveis 💙'). Prefira não usar emoji nenhum a usar mais de dois na mesma mensagem.",
